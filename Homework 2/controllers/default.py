...
SHOP_LIST = {
    0: {'name': 'Safeway', 'ingredients':['pasta', 'oil', 'salt', 'anchovies']},
    1: {'name': "Trader Joe's", 'ingredients':['tuna', 'peanuts', 'beer']},
    2: {'name': 'The Milk Pail', 'ingredients':['yoghurt', 'bread', 'onions', 'parmesan']}
}
